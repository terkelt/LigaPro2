    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-2xl mx-auto p-6">
        ...
        <div className="space-y-6">
          ...
          <Card className="bg-card border-border">
            <CardHeader>
              <CardTitle className="text-lg">Menü-Layout</CardTitle>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    Wechsle zwischen zwei Menü-Designs
                  </p>
                </div>
                <Select
                  value={settings.menuLayout ?? "classic"}
                  onValueChange={(v) => updateSetting("menuLayout", v as "classic" | "modern")}
                >
                  <SelectTrigger className="w-48">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="classic">Klassisch (Liste)</SelectItem>
                    <SelectItem value="modern">Modern (Icon-Rail)</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              <div className="grid grid-cols-2 gap-3">
                <button
                  onClick={() => updateSetting("menuLayout", "classic")}
                  className={`p-3 rounded-lg border-2 text-center text-xs transition-all ${
                    (settings.menuLayout ?? "classic") === "classic"
                      ? "border-primary bg-primary/10"
                      : "border-border hover:border-muted-foreground/30"
                  }`}
                >
                  <div className="text-2xl mb-1">📋</div>
                  <p className="font-bold">Klassisch</p>
                  <p className="text-muted-foreground text-[10px]">Aufklappbare Liste mit Text</p>
                </button>
                <button
                  onClick={() => updateSetting("menuLayout", "modern")}
                  className={`p-3 rounded-lg border-2 text-center text-xs transition-all ${
                    (settings.menuLayout ?? "classic") === "modern"
                      ? "border-primary bg-primary/10"
                      : "border-border hover:border-muted-foreground/30"
                  }`}
                >
                  ...
                  <p className="text-muted-foreground text-[10px]">Icon-Rail mit Sektionen</p>
                </button>
              </div>
            </CardContent>
          </Card>
